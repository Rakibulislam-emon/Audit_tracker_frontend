...
export default function ManagerDashboard({ userName, role = "manager" }) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Welcome back, {userName}! Here is the overview of your site's
            performance.
          </p>
        </div>
        <PDFExportButton data={reportData} userName={userName} />
      </div>
