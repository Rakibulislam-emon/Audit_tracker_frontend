 ...
 */
const ObservationsTabContent = ({ session }) => (
    <TabsContent value={TAB_VALUES.OBSERVATIONS} className="mt-4">
        <ObservationManager session={session} />
    </TabsContent>
);
        ...
        <div className="p-4 md:p-6 space-y-6">
            ...
            <Tabs defaultValue={TAB_VALUES.TEAM} className="w-full">
                <TabsList className="bg-gray-100">
                    ...
                    <TabsTrigger className={"cursor-pointer"} value={TAB_VALUES.OBSERVATIONS}>
                        Observations
                    </TabsTrigger>
                ...
                <ObservationsTabContent session={session} />
                <ProblemsTabContent />
            </Tabs>
        </div>
    );
